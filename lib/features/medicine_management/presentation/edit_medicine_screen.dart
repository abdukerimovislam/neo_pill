                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      TextButton(onPressed: () { setState(() { _selectedShape = tempShape; _selectedColor = tempColor; }); Navigator.pop(ctx); }, child: Text(l10n.doneAction, style: const TextStyle(fontWeight: FontWeight.w800, fontSize: 16)))
                    ],
                  ),
                ),
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              ...
              title: Text(l10n.editCourse, style: theme.textTheme.titleLarge?.copyWith(fontWeight: FontWeight.w800, color: theme.colorScheme.onSurface)),
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: theme.colorScheme.surface.withValues(alpha: 0.5), shape: BoxShape.circle,
                ...
                GlassContainer(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(l10n.form, style: theme.textTheme.bodySmall?.copyWith(color: theme.colorScheme.onSurface.withValues(alpha: 0.5), fontWeight: FontWeight.w600)),
      ...
      floatingActionButton: Padding(
        ...
        child: SizedBox(
          ...
          child: ElevatedButton(
            ...
            child: Text(l10n.saveChanges, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w800)),
          ),
        ),
      ),
    );
