      ...
      body: Stack(
        children: [
          ...
          Positioned(
            top: -120,
            left: -90,
            child: _GlowOrb(size: 280, color: primaryGlow, blur: 140),
          ),
          Positioned(
            bottom: -100,
            right: -70,
            child: _GlowOrb(size: 240, color: secondaryGlow, blur: 130),
          ),
          Positioned.fill(
...
class _GlowOrb extends StatelessWidget {
  ...
  const _GlowOrb({required this.size, required this.blur, required this.color});
