...
extension GetMeasurementEntityCollection on Isar {
  IsarCollection<MeasurementEntity> get measurementEntitys => this.collection();
}

const MeasurementEntitySchema = CollectionSchema(
  ...
  deserialize: _measurementEntityDeserialize,
  deserializeProp: _measurementEntityDeserializeProp,
  idName: r'id',
  indexes: {
  ...
  links: {},
  embeddedSchemas: {},
  getId: _measurementEntityGetId,
  getLinks: _measurementEntityGetLinks,
  attach: _measurementEntityAttach,
  version: '3.1.0+1',
);

int _measurementEntityEstimateSize(
...
void _measurementEntitySerialize(
  MeasurementEntity object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
  ...
  writer.writeString(offsets[1], object.syncId);
  writer.writeDateTime(offsets[2], object.timestamp);
  writer.writeByte(offsets[3], object.type.index);
  writer.writeString(offsets[4], object.unit);
  writer.writeDouble(offsets[5], object.value1);
  writer.writeDouble(offsets[6], object.value2);
}

MeasurementEntity _measurementEntityDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = MeasurementEntity();
  object.id = id;
  object.notes = reader.readStringOrNull(offsets[0]);
  object.syncId = reader.readString(offsets[1]);
...
P _measurementEntityDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
const _MeasurementEntitytypeEnumValueMap = {
  'bloodPressure': 0,
  'heartRate': 1,
  'bloodSugar': 2,
  'weight': 3,
...
const _MeasurementEntitytypeValueEnumMap = {
  0: MeasurementTypeEnum.bloodPressure,
  1: MeasurementTypeEnum.heartRate,
  2: MeasurementTypeEnum.bloodSugar,
  3: MeasurementTypeEnum.weight,
  4: MeasurementTypeEnum.temperature,
  5: MeasurementTypeEnum.mood,
};

Id _measurementEntityGetId(MeasurementEntity object) {
  return object.id;
}
...
extension MeasurementEntityByIndex on IsarCollection<MeasurementEntity> {
  Future<MeasurementEntity?> getBySyncId(String syncId) {
    return getByIndex(r'syncId', [syncId]);
  }

  MeasurementEntity? getBySyncIdSync(String syncId) {
  ...
  Future<List<MeasurementEntity?>> getAllBySyncId(List<String> syncIdValues) {
    final values = syncIdValues.map((e) => [e]).toList();
    return getAllByIndex(r'syncId', values);
  }

  List<MeasurementEntity?> getAllBySyncIdSync(List<String> syncIdValues) {
    final values = syncIdValues.map((e) => [e]).toList();
  ...
  Future<Id> putBySyncId(MeasurementEntity object) {
    return putByIndex(r'syncId', object);
  }

  Id putBySyncIdSync(MeasurementEntity object, {bool saveLinks = true}) {
    return putByIndexSync(r'syncId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllBySyncId(List<MeasurementEntity> objects) {
...
extension MeasurementEntityQueryWhereSort
    on QueryBuilder<MeasurementEntity, MeasurementEntity, QWhere> {
  QueryBuilder<MeasurementEntity, MeasurementEntity, QAfterWhere> anyId() {
...
extension MeasurementEntityQueryObject
    on QueryBuilder<MeasurementEntity, MeasurementEntity, QFilterCondition> {}

extension MeasurementEntityQueryLinks
    on QueryBuilder<MeasurementEntity, MeasurementEntity, QFilterCondition> {}
...
extension MeasurementEntityQuerySortThenBy
    on QueryBuilder<MeasurementEntity, MeasurementEntity, QSortThenBy> {
  QueryBuilder<MeasurementEntity, MeasurementEntity, QAfterSortBy> thenById() {
    return QueryBuilder.apply(this, (query) {
...
extension MeasurementEntityQueryProperty
    on QueryBuilder<MeasurementEntity, MeasurementEntity, QQueryProperty> {
  QueryBuilder<MeasurementEntity, int, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'id');
    });
  }

  QueryBuilder<MeasurementEntity, String?, QQueryOperations> notesProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'notes');
    });
  }

  QueryBuilder<MeasurementEntity, String, QQueryOperations> syncIdProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MeasurementEntity, String, QQueryOperations> unitProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'unit');
    });
  }

  QueryBuilder<MeasurementEntity, double, QQueryOperations> value1Property() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'value1');
    });
  }

  QueryBuilder<MeasurementEntity, double?, QQueryOperations> value2Property() {
    return QueryBuilder.apply(this, (query) {
