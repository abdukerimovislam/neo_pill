  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (_scrollController.hasClients) {
        ...
        final offset =
            (10 * totalItemWidth) - (screenWidth / 2) + (_itemWidth / 2) + 16;
        ...
        itemBuilder: (context, index) {
          ...
          return GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              width: comfortMode ? 72 : _itemWidth,
              decoration: BoxDecoration(
                color: isSelected
                    ? theme.primaryColor
                    : theme.colorScheme.surface.withValues(alpha: comfortMode ? 0.9 : 0.6),
